...
# ╔═╡ 409465d9-64b3-4431-b656-3c7d2a5806da
begin
	using DataFrames
	using CSV
	using Plots
...
# ╔═╡ 021b4546-29e0-11ec-1c2b-09b93d8cdd9a
md"
# Exoplanet Data Exploration

A notebook for exploring the [NASA Exoplanet Archive](https://exoplanetarchive.ipac.caltech.edu/index.html) Planetary Systems Dataset

### Links
- [Archive Data: User Guide](https://exoplanetarchive.ipac.caltech.edu/docs/ICEexohelp.html)
...
An planet outside the Solar System
...
### Sections
1. Discovery by year
2. Discovery by method
3. Discovery by facilities
4. Are there any statisitically significant relationships between different data points?
5. What features of an Exoplanet make it more likely to be discovered?
"

# ╔═╡ b772f0e7-eb7b-4489-a2df-819a545d5fca
begin
	exo_df = CSV.read("NASA_Exoplanet_Data_Set.csv", DataFrame)
	exo_df = filter(:default_flag => ==(1), exo_df)
end

# ╔═╡ 8d532dd7-d52e-49c9-a17b-ea58a82a722f
md"
# Discovery By Year
"

# ╔═╡ 56d88f2a-1381-49d1-bace-86f1ae0cd74d
function number_of_discoveries_in_year(year::Int64, df::DataFrame)::Int32
	nrow(filter(:disc_year => ==(year), df))
end

# ╔═╡ 3efe5b68-747f-464b-9e7b-eed627687676
function plot_discoveries_by_year(df::DataFrame)
	extrema_df = describe(df, extrema => :extrema)
	disc_year_df = filter(:variable => ==(:disc_year), extrema_df)
	(min_year, max_year) = disc_year_df[1,2]
	years = min_year:max_year
	discoveries = []
	for year in years
		push!(discoveries, number_of_discoveries_in_year(year, df))
	end
	plot(years, discoveries, title="Discoveries By Year", label="Discoveries", lw=3)
	xlabel!("Year")
	ylabel!("# Discoveries")
end

# ╔═╡ 89d9db79-8271-40a9-b9ca-655fd3d7b816
plot_discoveries_by_year(exo_df)

# ╔═╡ 5887a637-592f-45cc-b28c-fbe33780ebeb
md"
# Discovery By Method
"

# ╔═╡ b68c413d-ea5c-49f1-b3d5-be7cae415bb9
function number_of_discoveries_using_method(method, df::DataFrame)::Int32
	nrow(filter(:discoverymethod => ==(method), df))
end

# ╔═╡ 866d472e-5ab4-4cf3-922c-46b7d73e3f5c
number_of_discoveries_using_method("Radial Velocity", exo_df)

# ╔═╡ 6b4a0b18-30f5-4237-8901-c86c7f82e414
md"
# Discovery By Facilities
"

# ╔═╡ d656aa1d-3fe3-4a11-86fa-a29a55136fb9
md"
# Question
#### Are there any statisitically significant relationships between different data points?
"

# ╔═╡ dfa4589f-0ad8-47af-985d-406b40cee31c
md"
# Question
#### What features of an Exoplanet make it more likely to be discovered?
"
